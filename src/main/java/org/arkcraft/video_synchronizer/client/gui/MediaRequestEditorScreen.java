...
final class MediaRequestEditorScreen extends Screen {
    ...
    protected void init() {
        ...
        int buttonWidth = Math.min(110, (editorWidth - 8) / 3);
        int buttonsLeft = (width - buttonWidth * 3 - 8) / 2;
        ...
        doneButton = addRenderableWidget(Button.builder(
                ...
                .bounds(buttonsLeft + buttonWidth + 4, height - 28, buttonWidth, 20).build());
        addRenderableWidget(Button.builder(
    ...
    private List<KeyValuePair> parseInitialValue() {
        ...
        String normalized = normalizer.apply(initialValue);
